...
GETH_ARGS="--datadir /qdata/dd --raft --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum --networkid 10 --verbosity 5 --nodiscover --unlock 0 --password /qdata/passwords.txt"
